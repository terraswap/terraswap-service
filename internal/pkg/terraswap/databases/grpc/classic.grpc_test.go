...
func TestClassicGetPairs(t *testing.T) {
	classicCon := NewClassic("terra.delightlabs.io:9090", "columbus-5", configs.LogConfig{})
...
func TestClassicActiveDenoms(t *testing.T) {
	var tsCon = NewClassic("terra.delightlabs.io:9090", "columbus-5", configs.LogConfig{})
